...
- **social-context** — capture voice, pillars, and platform preferences before writing
- **social-hook-writer** — generate and test opening lines independently
- **social-platform-strategy** — decide which platform to prioritize before writing
- **social-content-repurposer** — adapt a finished post across multiple platforms
