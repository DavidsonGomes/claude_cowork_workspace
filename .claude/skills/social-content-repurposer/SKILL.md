...
- Does not write original content from scratch — see **social-post-writer** for original posts
...
- **social-context** — establish voice, pillars, and platform mix before repurposing
- **social-platform-strategy** — decide which platforms to prioritize and why
- **social-post-writer** — write a single original post from scratch
- **social-thread-writer** — write a full multi-part thread
- **social-carousel-writer** — write and structure a carousel post
