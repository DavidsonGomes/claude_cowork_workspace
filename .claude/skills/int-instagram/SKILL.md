...
Integração com Instagram para monitorar perfis da Evolution e do Davidson. Suporta múltiplas contas via OAuth (Social Auth App).
...
SOCIAL_INSTAGRAM_1_ACCOUNT_ID=17841459051881171
SOCIAL_INSTAGRAM_1_PAGE_TOKEN=EAA... (permanente)
```
