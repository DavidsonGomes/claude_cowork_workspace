...
description: "Monthly close kickoff — initiates the month-end closing process with a checklist, simplified P&L, pending reconciliations, receivables, payables, and action items for Samara. Trigger when user says 'fechamento mensal', 'monthly close', 'inicia fechamento', 'kickoff do fechamento', or on the 1st of each month."
---

# Monthly Close Kickoff — Fechamento Mensal

Rotina mensal que inicia o processo de fechamento: gera checklist, DRE simplificada, pendências e ações para Samara.
...
3. **Emitir NFs pendentes** — listar NFs que precisam ser emitidas (Samara)
...
9. **Aprovar fechamento** — Davidson revisa e aprova
...
## Step 5 — Identificar pendências para Samara

Listar em bullets claros o que precisa da Samara:
...
- Impacto de eventos do mês (ex: Summit, parceria nova)
...
<div class="checklist-item">
  ...
  <div class="checklist-owner">Samara / Davidson / Auto</div>
</div>
```
