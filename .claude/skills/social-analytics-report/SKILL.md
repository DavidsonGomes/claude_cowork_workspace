...
python3 {project-root}/.claude/skills/int-instagram/scripts/instagram_client.py recent_posts evolution.foundation 10
python3 {project-root}/.claude/skills/int-instagram/scripts/instagram_client.py recent_posts agenciadgcode 10
```
...
|------------|-------|-----------|-------|-------|------------|-----------------|
| YouTube | Evolution API | 7.450 | — | 27 | 7.0% | "Evo v3 chegando" |
| Instagram | evolution.foundation | 686 | — | 18 | 3.9% | "Evo V3 funcionalidades" |
| Instagram | agenciadgcode | 273 | — | 76 | — | — |
| LinkedIn | Davidson Gomes | — | — | — | — | Perfil apenas |
