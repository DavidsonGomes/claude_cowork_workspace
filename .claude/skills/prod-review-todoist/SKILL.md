...
**Antes:** `Send Evolution Summit 01 registration link to Willian`
**Depois:** `[Operação] Enviar link de inscrição do Evolution Summit 01 para Willian`
...
**Antes:** `Upload web panel; grant Willian access`
**Depois:** `[Operação] Publicar painel web do Summit e liberar acesso para Willian`
...
Se o Davidson quiser ver detalhes do que mudou, ele pede.
