...
2. **Issues do Davidson** — listar issues atribuídas ao Davidson:
   ```
...
- **Minhas:** o que o Davidson precisa fazer primeiro (por prioridade)
...
- **Não alterar issues** — apenas ler e reportar. Mudanças só com aprovação do Davidson
