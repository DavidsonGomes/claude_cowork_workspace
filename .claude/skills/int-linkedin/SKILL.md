...
Integração com LinkedIn para monitorar perfil do Davidson e (futuramente) Company Page. Multi-account via OAuth (Social Auth App).
...
SOCIAL_LINKEDIN_1_PERSON_URN=urn:li:person:iErFhklzfn
```
