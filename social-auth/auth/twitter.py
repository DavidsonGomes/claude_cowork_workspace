    ...
    if not client_id:
        ...
        <div style="background:#182230;border:1px solid #344054;border-radius:12px;padding:40px;max-width:500px;width:100%;">
            ...
            <form action="/save/twitter" method="POST">
                <input name="label" type="text" placeholder="Nome da conta (ex: Davidson)" style="width:100%;padding:12px;background:#0C111D;border:1px solid #344054;border-radius:8px;color:#F9FAFB;font-size:14px;margin-bottom:12px;">
